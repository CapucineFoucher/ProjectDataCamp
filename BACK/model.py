...
class Model :
    ...
    def compile_model(self):
        # Compile the model
        return self.model.compile(optimizer=tf.keras.optimizers.legacy.Adam(learning_rate=0.001), loss='binary_crossentropy', metrics=['accuracy'])


    def train_model(self):
        # Train the model
        return self.model.fit(self.train_data, epochs=1, validation_data=self.test_data)
